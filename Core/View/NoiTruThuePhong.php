...
$htmlPage['sitemap'][] = array('Thuê Phòng', '');
$htmlPage['menu'] = 'noitru';
$htmlPage['mainTitle'] = 'Thuê Phòng';
$htmlPage['pageTitle'] = 'Thuê Phòng - Ký Túc Xá';
...
if(isset($htmlArea))
{
    foreach($htmlArea as $area)
    {
        ...
        echo '                    <li class="tabs_room' . ($i != 0 ? '' : ' active') . '" id="tabs_room_area_' . $area['id'] . '">DN ' . $area['name'] . '</li>' . "\n";
...
echo $tabs;
echo '                </div>
                <h2 class="list_header" style="margin-top:20px">Danh sách sinh viên mới vào</h2>
...
echo
            ...
            <div class="right applysidebar">
                ...
                <div id="student_info" class="box_info">Nhập mã sinh viên ở ô trên để lấy thông tin</div>
                <a class="button" href="#" onclick="studentChangeSex();return false;">Đổi giới tính</a>
                <h3>Ngày vào</h3>
                <input id="date_in" type="text" value="' . '01/02/2013' /*date('d/m/y')*/ . '" />
                <h3>Ngày ra</h3>
                <input id="date_out" type="text" value="30/06/2013" />
                <div id="vaolaiphongcu" style="margin-top: 20px;display:none">
                <a class="button" href="#">Vào lại phòng cũ</a>
                </div>
                <!--<h3>Chú ý</h3>
                <ul>
                    <li>- Với sinh viên năm 2011, vẫn sử dụng mã dự thi</li>
                    <li>- Với sinh viên có mã dự thi VHA, ko nhập số 0 ở đầu<li>
                    <li>- Với sinh viên có mã dự thi trường khác, nhập đầy đủ<li>
                </ul>-->
                </div>
            </div>
        </div>
