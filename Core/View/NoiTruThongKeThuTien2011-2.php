...
echo '    <div id="main">
        <div class="main">
            <div class="left">
                <h2 class="list_header" style="margin-top:20px">Danh sách phiếu thu kỳ 2 - 2011-2012</h2>
...
echo
                ...
                <div class="button"><a href="' . URL_PATH . 'noitru/thongke/thuphiokytucxa2011-2/indanhsach" class="button">Danh sách hóa đơn</a></div>
            </div>
            <div class="right">
