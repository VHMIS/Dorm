...
echo '</ul>
    ...
    <div class="button">' . ($htmlPrevTotal > 0 ? '<a href="' . URL_PATH . 'noitru/thongke/sinhvieno/thang/' . $_ssvUri['params']['month'] . '/indanhsach" class="button">Danh sách sinh viên ở trong tháng</a>' : '') . '</div>';
echo
            '</div>
            <div class="right">
            </div>
